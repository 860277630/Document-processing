...
//
// This file contains a simple example to demonstrate how to implement a callback class RMSSecurityCallback which is used
// for RMS encryption and decryption.

import com.foxit.sdk.pdf.RMSSecurityCallback;
import com.foxit.sdk.pdf.SecurityHandler;

public class RMSSecurityEvent extends RMSSecurityCallback {

    private byte[] key;

    public RMSSecurityEvent(byte[] key) {
        this.key = key;
    }
