...
public class psi {
    ...
    private static String output_path = "../output_files/psi/";
    private static float[] kPointsData = {
    ...
    public static void main(String[] args) throws PDFException {
        ...
        try {
            ...
            String output_file = output_path + "pressure_sensitive_ink.bmp";
            ...
            float width = 480.f;
            float height = 180.f;
            RectF rect = new RectF(page.getWidth() / 2 - width / 2, page.getHeight() / 2 - height / 2,
                    page.getWidth() / 2 + width / 2, page.getHeight() / 2 + height / 2);

            Annot annot = psi.convertToPDFAnnot(page, rect, e_Rotation0);

            output_file = output_path + "pressure_sensitive_ink.pdf";
            doc.saveAs(output_file, e_SaveFlagNormal);
            System.out.println("PSI test.");
        } catch (Exception e) {
            e.printStackTrace();
        }
        Library.release();
